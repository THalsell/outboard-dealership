        ...
        <div className="flex items-start justify-between">
          <div>
            ...
            <p className="text-blue-100 mb-4">
              Manage your orders, service history, and account preferences
            </p>
            <div className="flex items-center gap-4 text-sm">
              <div className="flex items-center gap-1">
                <span className="text-yellow-300">⭐</span>
                <span>Loyalty Tier: {state.user?.profile?.tier}</span>
              </div>
              <div className="flex items-center gap-1">
                <span className="text-green-300">💎</span>
                <span>{state.user?.profile?.loyaltyPoints} Points</span>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900">{state.user?.profile?.loyaltyPoints || 0}</p>
            </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Find motors, parts, and accessories</p>
            </div>
          </div>
        </Link>
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Book maintenance or repairs</p>
            </div>
          </div>
        </Link>
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="font-semibold text-gray-900">Use Calculators</h3>
              <p className="text-sm text-gray-600">Performance, financing, and more</p>
            </div>
          </div>
        </Link>
      </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                <p className="text-sm text-gray-900">Order #ORD-2024-002 has been shipped</p>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                <p className="text-sm text-gray-900">Service appointment completed</p>
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-lg shadow p-6">
              ...
              <nav className="mt-6 space-y-2">
                ...
                <button
                  onClick={logout}
                  className="w-full flex items-center gap-3 px-3 py-2 text-left rounded-lg text-red-600 hover:bg-red-50 transition-colors mt-8"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
