            ...
            {activeTab === "horsepower" && (
              <div className="space-y-6 animate-fadeIn">
                ...
                <p className="text-lg text-gray-700 mb-6 text-center max-w-3xl mx-auto">
                  Selecting the correct horsepower is crucial for optimal
                  performance, fuel efficiency, and safety. Here&apos;s how to
                ...
                <GridSection
                  ...
                  renderItem={(item, index) => (
                    <div key={index} className="p-8 text-center bg-white">
                      <h3 className="text-2xl underline font-bold text-deep-blue mb-4">
                        {item.title}
                      </h3>
                      {item.length && (
                        <div className="mb-4">
                  ...
                  renderItem={(brand, index) => (
                    <div key={index} className="p-8 text-center bg-white">
                      ...
                      <div className="text-xl font-semibold text-gray-800 mb-2">
                        {"★".repeat(brand.maxStars)} {brand.rating}/5.0
                      </div>
                ...
                <GridSection
                  ...
                  renderItem={(item, index) => (
                    <div key={index} className="p-8 text-center bg-white">
                      ...
                      {item.items && (
                        <ul className="text-gray-700 text-lg leading-relaxed list-disc list-inside space-y-2">
