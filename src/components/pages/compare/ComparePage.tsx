...
// Components
import ProductDropdown from '@/components/pages/compare/ProductDropdown';
import ProductDisplay from '@/components/pages/compare/ProductDisplay';
import ComparisonTable from '@/components/pages/compare/ComparisonTable';

// Hooks & Utils
import { useProducts } from '@/hooks/useProducts';
import { getSpecValue } from '@/components/pages/compare/compare-utils';
import { MAX_PRODUCTS, SPEC_CATEGORIES } from '@/components/pages/compare/compare-constants';
