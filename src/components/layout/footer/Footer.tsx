...
import NewsletterSignup from "@/components/ui/forms/NewsletterSignup";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a
                  href="https://outboard-practice-store.myshopify.com/account"
                  className="text-xs text-gray-400 hover:text-blue-400"
                >
                  Order Tracking
                </a>
          ...
          <div>
            ...
            <address className="text-xs text-gray-400 not-italic space-y-2">
              ...
              <p className="break-all">
                <a
                  href="mailto:eli@claypowersports.com"
