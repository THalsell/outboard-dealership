...
export default function UserAccountMenu() {
  ...
  return (
    <div className="relative" ref={menuRef}>
      ...
      >
        <Image src="/user.svg" alt="User" width={20} height={20} className="w-4 h-4 sm:w-5 sm:h-5 filter brightness-0 invert" />
        <Image src="/down.svg" alt="Dropdown" width={16} height={16} className="w-3 h-3 sm:w-4 sm:h-4 filter brightness-0 invert" />
      </button>
